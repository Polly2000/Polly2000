...
- ⚡ Fun fact: one day I was interested `node.js` (`express` framework and also `MongoDB`) and built an authentication in my todo-list project (in progress) - [Frontend](https://github.com/Polly2000/todo-list/tree/dev), [Backend](https://github.com/Polly2000/todo-list-backend/tree/dev)
